...
- [ ] Explain what a token is used for.
    ...
    A token is used for authentication purposes to make sure you are who you say you are in a sense. 

- [ ] What steps can you take in your web apps to keep your data secure?

    Use private routes, make sure private routes are protected, and redirect anyone who has signed in of if they try to access a page without a token then redirect them to the login

- [ ] Describe how web servers work.

    A web server works by gathering the IP address form the domain name, then requests the full URL, after getting the request it displays the webpage in the browser. 

- [ ] Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.

    Put, post and Get can be mapped to the CRUD acronym when interfacing with APIs/servers.
